package com.worldscience.chatszone.Adapters;
...
import com.worldscience.chatszone.databinding.DeleteDialogBinding;
import com.worldscience.chatszone.databinding.ItemReceiveGroupBinding;
import com.worldscience.chatszone.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SentViewHolder.class) {
            ...
            viewHolder.itemView.setOnLongClickListener(v -> {
                @SuppressLint("InflateParams") View view = LayoutInflater.from(context).inflate(R.layout.delete_dialog,
                        null);
                DeleteDialogBinding binding = DeleteDialogBinding.bind(view);
                AlertDialog dialog = new AlertDialog.Builder(context)
                        .setTitle("Delete Message")
